...
- 데이터 전달 보증<br>
- 순서 보장<br>
- 보내는 측과 받는 측의 데이터 처리 속도를 조절해주는 <strong>흐름제어</strong> 지원<br>
- 네트워크 상에 패킷 수가 넘치지 않도록 조절해주는 <strong>혼잡제어</strong> 지원<br>
즉, 신뢰할 수 있는 프로토콜 / 현재는 대부분 TCP사용<br>
...
<h4> 클라이언트와 서버가 한 번 연결을 맺은 후, 클라이언트 요청에 대해 서버가 응답을 마치면 맺었던 연결을 끊어 버리는 성질 </h4>
